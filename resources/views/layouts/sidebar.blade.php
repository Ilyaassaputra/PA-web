            ...
            <div class="user">
                <div class="avatar-sm float-left mr-2">
                    @if(Auth::user() && Auth::user()->DataPendaftar && Auth::user()->DataPendaftar->foto)
                        <img src="{{ asset(Auth::user()->DataPendaftar->foto) }}" alt="Profile Image" class="avatar-img rounded-circle">
                    @else
                        <img src="../assets/img/profile.jpg" alt="Default Image" class="avatar-img rounded-circle">
                    @endif
                </div>
                <div class="info">
